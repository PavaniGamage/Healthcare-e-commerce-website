...
import ApplicationPage from "./WebPages/Application";
      ...
      <CartProvider>
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route
              path="/payment_history/:orderID"
              element={<PaymentHistoryItem />}
            />
            ...
            <Route
              path="/success-prescription-payment"
              element={<SuccessPagePrescription />}
            />
            <Route
              path="/cancel-prescription-payment"
              element={<CancelPagePrescription />}
            />
