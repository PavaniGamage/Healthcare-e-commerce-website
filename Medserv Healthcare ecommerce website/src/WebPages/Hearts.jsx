...
export default function Hearts() {
  ...
  return (
    <div>
      <section className="bg-[#000] bg-opacity-90 p-4 mx-auto">
      ...
      <section className="bg-[#181a87] ">
        <div className="grid max-w-screen-xl px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">
              Your Health - Our Priority
            </h1>
